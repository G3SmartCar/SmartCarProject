...
public class SerialOutput implements SerialPortEventListener {
        ...
        */
        ...
        public void initialize() {
                ...
                // gets us into the while loop and was suggested here was suggested http://www.raspberrypi.org/phpBB3/viewtopic.php?f=81&t=32$
        ...
        public void sendSerial(byte[] outMsg){
                try {
                        String text = new String(outMsg);
